...
PENGUIN_CLIENT_ID="penguin-ppGO3dKSGu-1758442565993"
PENGUIN_CLIENT_SECRET="ijPebtONtYLxNYxfL3DnUTPkRtoTHqqR"
...
if [ ${RUN_TYPE} = "spring" ]; then
  ...
  export PENGUIN_CLIENT_ID=${PENGUIN_CLIENT_ID}
  export PENGUIN_CLIENT_SECRET=${PENGUIN_CLIENT_SECRET}
